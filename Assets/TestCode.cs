...
public class TestCode : MonoBehaviour
{
    ...
    private RawImage RawImage_rImg;
    private Image Button111_img;
    private Button Button1111_btn;
    ...
    private Transform Viewport_trans;
    ...
    private Transform Viewport17_trans;
    ...
    private void Start()
    {
        ...
        this.Image_img = this.transform.Find("Image").GetComponent<Image>();
        this.RawImage_rImg = this.transform.Find("RawImage").GetComponent<RawImage>();
        this.Button111_img = this.transform.Find("Button111").GetComponent<Image>();
        this.Button1111_btn = this.transform.Find("Button111").GetComponent<Button>();
        this.Text2_txt = this.transform.Find("Button111/Text").GetComponent<Text>();
        ...
        this.Viewport_trans = this.transform.Find("Scroll View/Viewport").GetComponent<Transform>();
        ...
        this.Viewport17_trans = this.transform.Find("Dropdown/Template/Viewport").GetComponent<Transform>();
    ...
    {
        this.Button1111_btn.onClick.AddListener(this.OnButton1111_btnClicked);
    ...
    private void OnButton1111_btnClicked()
    {
